          ...
          <div className="grid gap-8 md:grid-cols-3">
            <Card className="group border-border bg-card transition-colors hover:border-primary/50">
              <CardContent className="p-8">
                ...
                <p className="text-muted-foreground">
                  50-hour courses with 90% filler content. You can read the
                  same in 5 hours.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="group border-border bg-card transition-colors hover:border-primary/50">
              <CardContent className="p-8">
                <MapOff className="mb-4 h-12 w-12 text-primary" />
                <h3 className="mb-2 text-xl font-semibold">No Roadmap</h3>
                <p className="text-muted-foreground">
                  Random tutorials with no structure. You're lost after 10
                  videos.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="group border-border bg-card transition-colors hover:border-primary/50">
              <CardContent className="p-8">
                <Skull className="mb-4 h-12 w-12 text-primary" />
                <h3 className="mb-2 text-xl font-semibold">
                  Outdated Content
                </h3>
                <p className="text-muted-foreground">
                  2020 tutorials teaching you deprecated tech. The job market
                  moved on.
                </p>
              </CardContent>
            </Card>
          ...
          <div className="grid items-center gap-16 lg:grid-cols-2">
            <div>
              ...
              <p className="mb-8 text-muted-foreground">
                From zero to 20 LPA in 6 months. Here's how KODEXI gets you
                there.
              </p>
              <Link
                to="/signup"
              ...
              {[
                {
                  ...
                  description:
                    'Select your goal: MAANG, Startup, or Product role.',
                },
                {
                  icon: BookOpen,
                  title: 'Read Curated Modules',
                  description: 'Text-first content. 10x faster than videos.',
                },
                {
                  icon: Code,
                  title: 'Practice Problems',
                  description:
                    'Real interview questions. Build muscle memory.',
                },
                {
                  icon: Users,
                  title: 'Mock Interviews',
                  description:
                    'AI-powered feedback. Simulate the real experience.',
                },
              ].map((step, index) => (
                <div key={index} className="relative flex gap-4 border-l border-border pl-8">
        ...
        <div className="container mx-auto px-4">
          <div className="mb-12 grid gap-8 md:grid-cols-4">
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                The text-first placement OS for Indian engineering students.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-muted-foreground">
                <li>
                  <a href="mailto:hello@kodexi.in" className="hover:text-foreground">
                    hello@kodexi.in
                  </a>
                </li>
                <li>
